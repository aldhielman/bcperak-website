...
<div id="header_wrapper">
  <header id="header" class="clearfix">
    <div class="logo_wrap">
      <?php if ($logo): ?>
        <div id="logo"><a href="<?php print $front_page; ?>" title="<?php print t('BERANDA'); ?>"><img src="<?php print $logo; ?>"/></a></div>
      <?php endif; ?>
      <h1 id="site-title">
        <div id="site-description"><?php print $site_slogan; ?></div>

        <div id="site-subtitle"><?php print t('KANTOR WILAYAH DJBC JAWA TIMUR I'); ?></div>

        <a href="<?php print $front_page; ?>" title="<?php print t('BERANDA'); ?>"><?php print $site_name; ?></a>        
      </h1>
    </div>
...
<div id="footer">
  ...
  <div class="credits">
    <?php print t('Created by'); ?><a href="http://bcperak.net"> bcperak.net</a>
  </div>
